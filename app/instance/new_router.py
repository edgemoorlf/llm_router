"""
New instance router implementation with separated config and state.

This module provides a new implementation of the InstanceRouter class
that works with the separated configuration and state architecture.
"""
